...
class Node:
    def __init__(self, data=None):
        ...
        self.prev = None   # Pointer to the previus node in the list
...
class SinglyLinkedList:
    ...
    def insertAtFront(self, value=None): #creates new Node with data val at front returns new head
        ...
        aux.prev = new_node  # Set the prev pointer of the old first node to the new node
        return self.head
    ...
    def insertAtBack(self, value): #creates new Node with data val at end
        ...
        self.last.prev = aux  # Set the previus pointer of the new node to the previus last node 
        return self.last
    ...
    def insertAfter(self, head, value, loc): #creates new Node with data val after Node loc
        ...
        #set the prev pointer of the next current node to the new node
    ...
    def deleteFront(self, head):   # Definition of the `deleteFront` function that takes the head of the list as a parameter
        ...
        self.head.prev = None  #Update the pointer of the new head to None
    ...
    def deleteNode(self,head, loc): #deletes Node loc; returns head
        ...
        #set the prev pointer of the current next node to the aux node
